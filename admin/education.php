...
$rows = $pdo->query('SELECT * FROM education ORDER BY sort_order, start_year DESC')->fetchAll();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="admin-container">
        <div class="header">
            ...
            <div>
                ...
                <a class="btn" href="education_edit.php">Add</a>
            </div>
        </div>
        <table>
            <thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($r['degree']); ?></td>
                    <td><?php echo htmlspecialchars($r['institution']); ?></td>

                    <td><?php echo htmlspecialchars($r['start_year'] . ' - ' . $r['end_year']); ?></td>

                    <td>
                        <a class="btn" href="education_edit.php?id=<?php echo (int)$r['id']; ?>">Edit</a>
